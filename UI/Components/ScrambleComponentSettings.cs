...
{
    public partial class ScrambleComponentSettings : UserControl
    {
        ...
        public String TextScramble { get; set; }
		...
		public ScrambleComponentSettings()
        {
            InitializeComponent();
			...
			TextScramble = Scrambler.scramble();
            OverrideFont1 = false;
            OverrideFont2 = false;
			...
			txtOne.DataBindings.Add("Text", this, "TextScramble");
